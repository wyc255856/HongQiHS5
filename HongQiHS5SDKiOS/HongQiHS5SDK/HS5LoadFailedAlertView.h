...
@class HS5LoadFailedAlertView;

@protocol LoadFailedAlertViewDelegate <NSObject>

- (void)loadFailedAlertView:(HS5LoadFailedAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex;

@end


@interface HS5LoadFailedAlertView : UIView
